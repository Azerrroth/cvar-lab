...
class VGG(nn.Module):
    def __init__(self):
        ...
        self.model = models.vgg19(
            pretrained=True
        ).features[:29]  #model will contain the first 29 layers
...
original_image = image_loader(os.path.join(path, "style-target.jpeg"))
style_image = image_loader(os.path.join(path, "style.jpg"))
